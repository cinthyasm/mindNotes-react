      ...
      <div className='col-xs-12 col-sm-6 col-md-3'>
        <div className={this.props.isActiveNote ? null : 'note-block'} onClick={this.props.openNote}>
          <div className='note note-modal--content'>
            ...
            <div className='note--title' contentEditable='true'>{title} </div>
            <div className='note--description' contentEditable='true'>{description}</div>
            <div className='footer'>
              ...
              <button className='btn btn-default footer--btn-save' onClick={this.props.closeNote}>Save</button>
            </div>
